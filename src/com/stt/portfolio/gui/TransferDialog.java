...
public class TransferDialog extends BaseDialog {
	...
	public TransferDialog(Component frameComp, Component locationComp, String title, I_TickerManager tickerManager) {
		...
		updateRateFieldCcy((String) currencyList.getSelectedItem());
	...
	protected Component[] getDialogComponents() {
		Component[] components = { dateChooser, currencyList, rateField, totalCostField };
		return components;
	}

	protected JLabel[] getDialogLabels() {
		JLabel[] labels = { dateFieldLabel, currencyFieldLabel, rateFieldLabel, totalCostFieldLabel };
		return labels;
	}
