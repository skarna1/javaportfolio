...
public class XIRRData {
	...
	static GregorianCalendar dateStart = new GregorianCalendar( 1899, 11, 30 ) ;
...
//	}
	 ...
	 *  @return
	 */
	public static double getExcelDateValue( Date date ) {
		Calendar cal = new GregorianCalendar();
		cal.setTime(date);
		return (double) getExcelDateValue(cal);
	}
